...
def make_barplot(dataset_order: List[str], results: Dict[str, Tuple[float, float]], out_path: str) -> None:
    ...
    ax.set_xticks(x)
    ax.set_xticklabels(["PS 18", "CS 18", "ES 18", "PS 11-25", "CS 11-25", "ES 11-25"], rotation=0, fontsize=18)
    ax.set_ylim(0, 125)
...
def main() -> None:
    ...
    out_path = "/data/P70087789/GNN/data/dataset_classification/images/classification_accuracy_product_states_18_by_label.png"
